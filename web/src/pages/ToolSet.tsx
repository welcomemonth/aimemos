              ...
              <div className="grid grid-cols-1 divide-y divide-border">
                {filteredTools.map((tool) => (
                  ...
                  >
                    ...
                    <button className="p-2 text-muted-foreground hover:text-primary hover:bg-background rounded-lg transition-all border border-transparent hover:border-border">
