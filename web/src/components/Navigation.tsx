import { BellIcon, EarthIcon, ToolCaseIcon, LibraryIcon, BotMessageSquareIcon, PaperclipIcon, UserCircleIcon } from "lucide-react";
...
const Navigation = (props: Props) => {
  ...
  const chatNavLink: NavLinkItem = {
    ...
    path: Routes.CHAT,
    title: t("common.chat"),
    icon: <BotMessageSquareIcon className="w-6 h-auto shrink-0" />,
  };
  ...
  const navLinks: NavLinkItem[] = currentUser
    ? [homeNavLink,toolLink, exploreNavLink, chatNavLink, attachmentsNavLink, inboxNavLink]
    : [exploreNavLink,toolLink,chatNavLink, signInNavLink];
